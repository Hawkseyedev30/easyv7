...
(function (exports) {
    ...
    var ame2eea = {
        encryptPayload: function (t) {
            var k = 'QTc4REMyRDc3M0M0NEJDOUJGNEQxQjJCNkVFN0EwMkQ=';
            try {
        ...
        encryptDtag: function (t) {

            console.log(t)
            var k = 'NEE1QzcxM0QxQzNCNkI4QjRDOUE2ODcwQTczQzFENjI=';
            try {
                return amRsa.oaep.encryptMsisdn(t, k);
            } catch (s) {
                throw ame2eea.log("Exception when encrypting using RSA-OAEP, msg=" + s),
    ...
    amUtil.rng_get_byte = function () {
        ...
        let Base64 = {
            ...
            encodeByteArray: function (t, r) {
                this.init_()
                for (var e = r ? this.byteToCharMapWebSafe_ : this.byteToCharMap_, n = [], i = 0; i < t.length; i += 3) {
                    var o = t[i]
                        , a = i + 1 < t.length
                        , s = a ? t[i + 1] : 0
                        , h = i + 2 < t.length
